            ...
            <Container className='mt-5'>
                <Row >
                    <Col xs={12} md={6} className='mobile mt-3'>
                        ...
                        <a class="btn btn-primary resume-btn mt-3" href="https://docs.google.com/document/d/1bkkTHuGME-eRuJhYOy1tVtqcRryvbjnXdvs7wKv4Mqw/edit" role="button"><AiOutlineFilePdf className='pdf-icon' />Click Me</a>
